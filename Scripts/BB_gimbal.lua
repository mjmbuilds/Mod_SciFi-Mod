--[[
This code is borrowed from Brent Batch.
I plan to have these work a bit differnt later on, but for now they are just a scifi re-skin of the gimbal thrusters in the main Modpack, and use Brent's script.
]]--
